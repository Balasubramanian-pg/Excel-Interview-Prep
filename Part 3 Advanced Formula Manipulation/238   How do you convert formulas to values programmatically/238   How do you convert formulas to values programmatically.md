...
- [README.md](..\README.md) <!-- score: 1.327 | shared: formulas, how, programmatically, values, you -->
- [51   What is OFFSET and when do you use it.md](..\Advanced Formula Techniques\51   What is OFFSET and when do you use it.md) <!-- score: 1.198 | shared: formulas, how, values, you -->
- [66   How do you sum top or bottom N values.md](..\Conditional Aggregation\66   How do you sum top or bottom N values.md) <!-- score: 1.190 | shared: formulas, how, values, you -->
- [70   How do you count unique values with criteria.md](..\Conditional Aggregation\70   How do you count unique values with criteria.md) <!-- score: 1.181 | shared: formulas, how, values, you -->
- [56   How do you remove duplicates with formulas.md](..\Advanced Formula Techniques\56   How do you remove duplicates with formulas.md) <!-- score: 1.175 | shared: formulas, how, values, you -->
