...
- [136   How do you create cross-tabulation  pivot-like  formulas.md](136   How do you create cross-tabulation  pivot-like  formulas.md) <!-- score: 3.091 | shared: array, cell, changes, column, columns -->
- [52   How do you create a dynamic named range.md](..\Advanced Formula Techniques\52   How do you create a dynamic named range.md) <!-- score: 3.062 | shared: adjusts, automatically, based, cell, cells -->
- [115   How do you split text into columns with formulas.md](..\Advanced Data Manipulation\115   How do you split text into columns with formulas.md) <!-- score: 2.879 | shared: array, automatically, cell, cells, changes -->
- [139   How do you flatten nested arrays.md](139   How do you flatten nested arrays.md) <!-- score: 2.868 | shared: array, arrays, automatically, blank, cells -->
- [117   How do you create custom sorting orders.md](..\Advanced Data Manipulation\117   How do you create custom sorting orders.md) <!-- score: 2.839 | shared: array, based, cell, column, create -->
