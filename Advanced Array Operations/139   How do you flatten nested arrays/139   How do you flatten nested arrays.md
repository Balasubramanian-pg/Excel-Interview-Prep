...
- [137   How do you create dynamic arrays that resize.md](137   How do you create dynamic arrays that resize.md) <!-- score: 2.901 | shared: array, arrays, automatically, blank, cells -->
- [114   How do you unpivot data  columns to rows.md](..\Advanced Data Manipulation\114   How do you unpivot data  columns to rows.md) <!-- score: 2.792 | shared: any, column, columns, excel, flattening -->
- [115   How do you split text into columns with formulas.md](..\Advanced Data Manipulation\115   How do you split text into columns with formulas.md) <!-- score: 2.762 | shared: array, automatically, both, cells, columns -->
- [136   How do you create cross-tabulation  pivot-like  formulas.md](136   How do you create cross-tabulation  pivot-like  formulas.md) <!-- score: 2.686 | shared: array, column, columns, excel, formula -->
- [125   How do you use array logic for complex conditions.md](..\Advanced Conditional Logic\125   How do you use array logic for complex conditions.md) <!-- score: 2.662 | shared: ability, any, array, arrays, calculations -->
