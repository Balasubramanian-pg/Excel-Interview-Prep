...
- [README.md](..\README.md) <!-- score: 1.552 | shared: array, formula, formulas, how, performance -->
- [225   How do you handle formula versioning.md](..\Performance and Optimization Formulas\225   How do you handle formula versioning.md) <!-- score: 1.420 | shared: array, formula, formulas, how, performance -->
- [76   How do you extract numbers from text.md](..\Text Pattern Matching\76   How do you extract numbers from text.md) <!-- score: 1.396 | shared: array, formula, formulas, performance, vba -->
- [66   How do you sum top or bottom N values.md](..\Conditional Aggregation\66   How do you sum top or bottom N values.md) <!-- score: 1.317 | shared: array, formula, formulas, how, you -->
- [70   How do you count unique values with criteria.md](..\Conditional Aggregation\70   How do you count unique values with criteria.md) <!-- score: 1.309 | shared: array, formula, formulas, how, you -->
