...
- [56   How do you remove duplicates with formulas.md](..\Advanced Formula Techniques\56   How do you remove duplicates with formulas.md) <!-- score: 1.175 | shared: formulas, how, work, you -->
- [183   BI  How do you calculate year-to-date  YTD  metrics.md](..\Advanced Business Intelligence Formulas\183   BI  How do you calculate year-to-date  YTD  metrics.md) <!-- score: 1.172 | shared: formulas, how, work, you -->
- [137   How do you create dynamic arrays that resize.md](..\Advanced Array Operations\137   How do you create dynamic arrays that resize.md) <!-- score: 1.143 | shared: formulas, how, work, you -->
- [Practical Scenarios.md](..\Advanced Level\Practical Scenarios.md) <!-- score: 1.140 | shared: formulas, how, query, you -->
- [Advanced Features.md](..\Advanced Level\Advanced Features.md) <!-- score: 1.093 | shared: formulas, how, query, you -->
