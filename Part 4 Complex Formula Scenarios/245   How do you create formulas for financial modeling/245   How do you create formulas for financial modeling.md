...
- [README.md](..\README.md) <!-- score: 1.444 | shared: analysis, create, financial, formulas, how -->
- [Advanced Features.md](..\Advanced Level\Advanced Features.md) <!-- score: 1.337 | shared: analysis, create, formulas, how, modeling -->
- [51   What is OFFSET and when do you use it.md](..\Advanced Formula Techniques\51   What is OFFSET and when do you use it.md) <!-- score: 1.325 | shared: analysis, create, formulas, how, you -->
- [183   BI  How do you calculate year-to-date  YTD  metrics.md](..\Advanced Business Intelligence Formulas\183   BI  How do you calculate year-to-date  YTD  metrics.md) <!-- score: 1.299 | shared: analysis, create, formulas, how, you -->
- [181   BI  How do you create rolling moving averages.md](..\Advanced Business Intelligence Formulas\181   BI  How do you create rolling moving averages.md) <!-- score: 1.282 | shared: analysis, create, formulas, how, you -->
