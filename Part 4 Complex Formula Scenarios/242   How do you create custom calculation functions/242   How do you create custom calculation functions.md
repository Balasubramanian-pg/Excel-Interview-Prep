...
- [README.md](..\README.md) <!-- score: 1.444 | shared: array, create, custom, functions, how -->
- [66   How do you sum top or bottom N values.md](..\Conditional Aggregation\66   How do you sum top or bottom N values.md) <!-- score: 1.434 | shared: array, create, functions, how, return -->
- [117   How do you create custom sorting orders.md](..\Advanced Data Manipulation\117   How do you create custom sorting orders.md) <!-- score: 1.383 | shared: array, create, custom, functions, how -->
- [54   How do you use array constants.md](..\Advanced Formula Techniques\54   How do you use array constants.md) <!-- score: 1.382 | shared: array, create, functions, how, worksheet -->
- [225   How do you handle formula versioning.md](..\Performance and Optimization Formulas\225   How do you handle formula versioning.md) <!-- score: 1.312 | shared: array, calculation, create, functions, how -->
