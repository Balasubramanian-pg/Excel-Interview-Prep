...
- [24   What is DATEDIF and how do you use it.md](24   What is DATEDIF and how do you use it.md) <!-- score: 3.263 | shared: age, between, calculate, calculates, calculation -->
- [25   How do you calculate working days.md](25   How do you calculate working days.md) <!-- score: 2.821 | shared: between, calculate, calculates, calculation, calculations -->
- [64   How do you count cells with specific text.md](..\Conditional Aggregation\64   How do you count cells with specific text.md) <!-- score: 2.802 | shared: alternative, containing, count, end, exactly -->
- [22   Explain time functions.md](22   Explain time functions.md) <!-- score: 2.748 | shared: automatically, calculate, calculation, calculations, cell -->
- [74   How do you validate date ranges.md](..\Data Validation Formulas\74   How do you validate date ranges.md) <!-- score: 2.717 | shared: alternative, cell, current, date, dates -->
