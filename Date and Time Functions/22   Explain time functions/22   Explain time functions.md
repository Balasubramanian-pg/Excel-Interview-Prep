...
- [21   Explain common date functions.md](21   Explain common date functions.md) <!-- score: 3.768 | shared: arguments, arithmetic, automatically, calculate, calculation -->
- [23   How do you calculate age from birthdate.md](23   How do you calculate age from birthdate.md) <!-- score: 2.781 | shared: automatically, calculate, calculation, calculations, cell -->
- [34   What is AGGREGATE function.md](..\Counting and Summing Functions\34   What is AGGREGATE function.md) <!-- score: 2.618 | shared: calculation, examples, excel, explains, function -->
- [25   How do you calculate working days.md](25   How do you calculate working days.md) <!-- score: 2.579 | shared: business, calculate, calculation, calculations, date -->
- [66   How do you sum top or bottom N values.md](..\Conditional Aggregation\66   How do you sum top or bottom N values.md) <!-- score: 2.518 | shared: calculate, create, creates, ctrl, excel -->
