...
- [25   How do you calculate working days.md](25   How do you calculate working days.md) <!-- score: 3.997 | shared: business, calculates, calculation, calculations, character -->
- [74   How do you validate date ranges.md](..\Data Validation Formulas\74   How do you validate date ranges.md) <!-- score: 2.890 | shared: business, custom, date, dates, day -->
- [23   How do you calculate age from birthdate.md](23   How do you calculate age from birthdate.md) <!-- score: 2.538 | shared: calculates, calculation, calculations, cases, containing -->
- [183   BI  How do you calculate year-to-date  YTD  metrics.md](..\Advanced Business Intelligence Formulas\183   BI  How do you calculate year-to-date  YTD  metrics.md) <!-- score: 2.363 | shared: before, business, calculates, calculations, date -->
- [51   What is OFFSET and when do you use it.md](..\Advanced Formula Techniques\51   What is OFFSET and when do you use it.md) <!-- score: 2.318 | shared: calculates, cases, dynamic, excel, function -->
