...
- [22   Explain time functions.md](22   Explain time functions.md) <!-- score: 3.795 | shared: arguments, arithmetic, automatically, calculate, calculation -->
- [23   How do you calculate age from birthdate.md](23   How do you calculate age from birthdate.md) <!-- score: 2.601 | shared: automatically, calculate, calculation, calculations, current -->
- [25   How do you calculate working days.md](25   How do you calculate working days.md) <!-- score: 2.514 | shared: calculate, calculation, calculations, common, date -->
- [66   How do you sum top or bottom N values.md](..\Conditional Aggregation\66   How do you sum top or bottom N values.md) <!-- score: 2.381 | shared: calculate, creates, excel, explains, functions -->
- [183   BI  How do you calculate year-to-date  YTD  metrics.md](..\Advanced Business Intelligence Formulas\183   BI  How do you calculate year-to-date  YTD  metrics.md) <!-- score: 2.363 | shared: analysis, automatically, calculate, calculations, current -->
