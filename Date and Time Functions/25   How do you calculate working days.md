...
- [26   How do you add working days to a date.md](26   How do you add working days to a date.md) <!-- score: 3.938 | shared: business, calculates, calculation, calculations, character -->
- [74   How do you validate date ranges.md](..\Data Validation Formulas\74   How do you validate date ranges.md) <!-- score: 3.055 | shared: basic, business, custom, date, dates -->
- [24   What is DATEDIF and how do you use it.md](24   What is DATEDIF and how do you use it.md) <!-- score: 2.896 | shared: basic, beginning, between, calculate, calculates -->
- [23   How do you calculate age from birthdate.md](23   How do you calculate age from birthdate.md) <!-- score: 2.781 | shared: between, calculate, calculates, calculation, calculations -->
- [183   BI  How do you calculate year-to-date  YTD  metrics.md](..\Advanced Business Intelligence Formulas\183   BI  How do you calculate year-to-date  YTD  metrics.md) <!-- score: 2.629 | shared: beginning, both, business, calculate, calculates -->
