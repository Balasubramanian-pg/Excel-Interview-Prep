...
- [23   How do you calculate age from birthdate.md](23   How do you calculate age from birthdate.md) <!-- score: 3.317 | shared: age, between, calculate, calculates, calculation -->
- [25   How do you calculate working days.md](25   How do you calculate working days.md) <!-- score: 2.992 | shared: basic, beginning, between, calculate, calculates -->
- [69   How do you create weighted averages.md](..\Conditional Aggregation\69   How do you create weighted averages.md) <!-- score: 2.462 | shared: basic, before, calculate, calculates, calculation -->
- [22   Explain time functions.md](22   Explain time functions.md) <!-- score: 2.441 | shared: calculate, calculation, calculations, date, day -->
- [65   How do you sum based on partial text match.md](..\Conditional Aggregation\65   How do you sum based on partial text match.md) <!-- score: 2.439 | shared: basic, ending, example, excel, explains -->
