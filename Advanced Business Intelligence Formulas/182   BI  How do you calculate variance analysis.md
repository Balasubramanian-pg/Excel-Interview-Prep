...
- [120   How do you create running differences  deltas.md](..\Advanced Data Manipulation\120   How do you create running differences  deltas.md) <!-- score: 2.691 | shared: absolute, against, between, column, comparing -->
- [183   BI  How do you calculate year-to-date  YTD  metrics.md](183   BI  How do you calculate year-to-date  YTD  metrics.md) <!-- score: 2.565 | shared: analysis, assume, automatically, business, calculate -->
- [119   How do you group data into bins buckets.md](..\Advanced Data Manipulation\119   How do you group data into bins buckets.md) <!-- score: 2.563 | shared: assume, checks, column, contains, creating -->
- [181   BI  How do you create rolling moving averages.md](181   BI  How do you create rolling moving averages.md) <!-- score: 2.548 | shared: analysis, automatically, business, calculate, cell -->
- [59   How do you create running totals.md](..\Advanced Formula Techniques  Continued\59   How do you create running totals.md) <!-- score: 2.342 | shared: absolute, analysis, calculate, cell, column -->
