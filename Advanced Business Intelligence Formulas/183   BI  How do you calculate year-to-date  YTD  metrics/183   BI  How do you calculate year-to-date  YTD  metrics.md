...
- [181   BI  How do you create rolling moving averages.md](181   BI  How do you create rolling moving averages.md) <!-- score: 2.969 | shared: analysis, automatically, average, business, calculate -->
- [124   How do you create dynamic conditional formatting formulas.md](..\Advanced Conditional Logic\124   How do you create dynamic conditional formatting formulas.md) <!-- score: 2.731 | shared: before, calculates, cell, condition, create -->
- [51   What is OFFSET and when do you use it.md](..\Advanced Formula Techniques\51   What is OFFSET and when do you use it.md) <!-- score: 2.718 | shared: analysis, average, calculate, calculates, cell -->
- [README.md](..\README.md) <!-- score: 2.657 | shared: analysis, calculate, calculations, conditions, create -->
- [67   How do you sum with multiple AND conditions.md](..\Conditional Aggregation\67   How do you sum with multiple AND conditions.md) <!-- score: 2.594 | shared: cell, condition, conditions, criteria, dynamic -->
