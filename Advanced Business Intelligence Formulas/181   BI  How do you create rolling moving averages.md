...
- [136   How do you create cross-tabulation  pivot-like  formulas.md](..\Advanced Array Operations\136   How do you create cross-tabulation  pivot-like  formulas.md) <!-- score: 3.037 | shared: array, calculate, cell, changes, classic -->
- [183   BI  How do you calculate year-to-date  YTD  metrics.md](183   BI  How do you calculate year-to-date  YTD  metrics.md) <!-- score: 2.987 | shared: analysis, automatically, average, business, calculate -->
- [51   What is OFFSET and when do you use it.md](..\Advanced Formula Techniques\51   What is OFFSET and when do you use it.md) <!-- score: 2.956 | shared: analysis, average, calculate, calculates, cell -->
- [124   How do you create dynamic conditional formatting formulas.md](..\Advanced Conditional Logic\124   How do you create dynamic conditional formatting formulas.md) <!-- score: 2.791 | shared: applies, calculates, cell, column, create -->
- [118   How do you calculate cumulative percentages.md](..\Advanced Data Manipulation\118   How do you calculate cumulative percentages.md) <!-- score: 2.751 | shared: analysis, calculate, calculation, cell, classic -->
