...
- [50   What is INDIRECT and when do you use it.md](..\Advanced Formula Techniques\50   What is INDIRECT and when do you use it.md) <!-- score: 3.737 | shared: available, behavior, best, cases, cell -->
- [51   What is OFFSET and when do you use it.md](..\Advanced Formula Techniques\51   What is OFFSET and when do you use it.md) <!-- score: 3.334 | shared: best, cases, cell, cells, compatibility -->
- [53   What is CHOOSE function.md](..\Advanced Formula Techniques\53   What is CHOOSE function.md) <!-- score: 3.263 | shared: available, behavior, best, cases, compatibility -->
- [54   How do you use array constants.md](..\Advanced Formula Techniques\54   How do you use array constants.md) <!-- score: 3.223 | shared: available, best, cases, cells, compatibility -->
- [58   What is GETPIVOTDATA.md](58   What is GETPIVOTDATA.md) <!-- score: 3.194 | shared: available, best, cell, cells, compatibility -->
