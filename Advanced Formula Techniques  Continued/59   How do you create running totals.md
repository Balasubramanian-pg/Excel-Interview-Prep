...
- [56   How do you remove duplicates with formulas.md](..\Advanced Formula Techniques\56   How do you remove duplicates with formulas.md) <!-- score: 3.208 | shared: analysis, array, changes, column, contains -->
- [62   How do you find the nth occurrence of a value.md](62   How do you find the nth occurrence of a value.md) <!-- score: 3.136 | shared: array, arrays, cases, column, compatible -->
- [61   How do you find the last value in a column.md](61   How do you find the last value in a column.md) <!-- score: 3.136 | shared: array, best, cases, column, contains -->
- [51   What is OFFSET and when do you use it.md](..\Advanced Formula Techniques\51   What is OFFSET and when do you use it.md) <!-- score: 3.068 | shared: analysis, best, calculate, cases, cell -->
- [55   What is TRANSPOSE function.md](..\Advanced Formula Techniques\55   What is TRANSPOSE function.md) <!-- score: 2.945 | shared: analysis, array, arrays, best, cases -->
