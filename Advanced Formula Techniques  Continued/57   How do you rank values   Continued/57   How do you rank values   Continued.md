...
- [57   How do you rank values.md](..\Advanced Formula Techniques\57   How do you rank values.md) <!-- score: 3.679 | shared: analysis, ascending, assign, assigns, average -->
- [56   How do you remove duplicates with formulas.md](..\Advanced Formula Techniques\56   How do you remove duplicates with formulas.md) <!-- score: 3.208 | shared: analysis, column, contains, contents, does -->
- [59   How do you create running totals.md](59   How do you create running totals.md) <!-- score: 2.909 | shared: analysis, cases, column, contains, contents -->
- [51   What is OFFSET and when do you use it.md](..\Advanced Formula Techniques\51   What is OFFSET and when do you use it.md) <!-- score: 2.839 | shared: adjusts, analysis, average, cases, column -->
- [61   How do you find the last value in a column.md](61   How do you find the last value in a column.md) <!-- score: 2.804 | shared: cases, column, contains, contents, does -->
