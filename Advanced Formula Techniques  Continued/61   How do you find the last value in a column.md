...
- [62   How do you find the nth occurrence of a value.md](62   How do you find the nth occurrence of a value.md) <!-- score: 3.439 | shared: apple, array, banana, cases, cells -->
- [56   How do you remove duplicates with formulas.md](..\Advanced Formula Techniques\56   How do you remove duplicates with formulas.md) <!-- score: 3.311 | shared: apple, array, banana, column, compatibility -->
- [59   How do you create running totals.md](59   How do you create running totals.md) <!-- score: 3.183 | shared: array, best, cases, column, contains -->
- [51   What is OFFSET and when do you use it.md](..\Advanced Formula Techniques\51   What is OFFSET and when do you use it.md) <!-- score: 3.068 | shared: best, cases, cells, column, columns -->
- [52   How do you create a dynamic named range.md](..\Advanced Formula Techniques\52   How do you create a dynamic named range.md) <!-- score: 3.062 | shared: apple, banana, cells, column, columns -->
