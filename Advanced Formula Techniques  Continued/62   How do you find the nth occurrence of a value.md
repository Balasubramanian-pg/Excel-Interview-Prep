...
- [61   How do you find the last value in a column.md](61   How do you find the last value in a column.md) <!-- score: 3.439 | shared: apple, array, banana, cases, cells -->
- [55   What is TRANSPOSE function.md](..\Advanced Formula Techniques\55   What is TRANSPOSE function.md) <!-- score: 3.367 | shared: adjacent, apple, array, arrays, banana -->
- [56   How do you remove duplicates with formulas.md](..\Advanced Formula Techniques\56   How do you remove duplicates with formulas.md) <!-- score: 3.362 | shared: apple, array, banana, column, contains -->
- [59   How do you create running totals.md](59   How do you create running totals.md) <!-- score: 3.183 | shared: array, arrays, cases, column, compatible -->
- [36   How do you count unique values.md](..\Counting and Summing Functions\36   How do you count unique values.md) <!-- score: 3.003 | shared: apple, array, arrays, banana, cells -->
