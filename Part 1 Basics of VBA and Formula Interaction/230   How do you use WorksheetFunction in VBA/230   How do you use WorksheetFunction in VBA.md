...
- [README.md](..\README.md) <!-- score: 1.200 | shared: advanced, how, vba, you -->
- [Advanced Features.md](..\Advanced Level\Advanced Features.md) <!-- score: 1.093 | shared: advanced, how, vba, you -->
- [225   How do you handle formula versioning.md](..\Performance and Optimization Formulas\225   How do you handle formula versioning.md) <!-- score: 1.068 | shared: advanced, how, vba, you -->
- [70   How do you count unique values with criteria.md](..\Conditional Aggregation\70   How do you count unique values with criteria.md) <!-- score: 1.040 | shared: how, uses, you -->
- [56   How do you remove duplicates with formulas.md](..\Advanced Formula Techniques\56   How do you remove duplicates with formulas.md) <!-- score: 1.034 | shared: how, uses, you -->
