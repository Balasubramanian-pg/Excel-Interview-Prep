...
- [64   How do you count cells with specific text.md](64   How do you count cells with specific text.md) <!-- score: 3.637 | shared: alternative, any, case, characters, column -->
- [35   How do you sum with multiple OR criteria.md](..\Counting and Summing Functions\35   How do you sum with multiple OR criteria.md) <!-- score: 3.616 | shared: added, any, based, check, column -->
- [68   How do you sum with OR conditions.md](68   How do you sum with OR conditions.md) <!-- score: 3.533 | shared: based, check, column, complex, conditions -->
- [67   How do you sum with multiple AND conditions.md](67   How do you sum with multiple AND conditions.md) <!-- score: 3.374 | shared: alternative, arguments, based, conditions, containing -->
- [33   What s the difference between SUM and SUMIF.md](..\Counting and Summing Functions\33   What s the difference between SUM and SUMIF.md) <!-- score: 3.071 | shared: any, arguments, based, conditions, criteria -->
