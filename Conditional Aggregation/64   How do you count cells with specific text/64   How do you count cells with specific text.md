...
- [65   How do you sum based on partial text match.md](65   How do you sum based on partial text match.md) <!-- score: 3.588 | shared: alternative, any, case, characters, column -->
- [66   How do you sum top or bottom N values.md](66   How do you sum top or bottom N values.md) <!-- score: 3.326 | shared: alternative, array, compatible, containing, count -->
- [70   How do you count unique values with criteria.md](70   How do you count unique values with criteria.md) <!-- score: 3.213 | shared: alternative, apple, array, cells, containing -->
- [67   How do you sum with multiple AND conditions.md](67   How do you sum with multiple AND conditions.md) <!-- score: 3.116 | shared: alternative, contain, containing, criteria, evaluate -->
- [36   How do you count unique values.md](..\Counting and Summing Functions\36   How do you count unique values.md) <!-- score: 3.112 | shared: alternative, apple, array, cells, containing -->
