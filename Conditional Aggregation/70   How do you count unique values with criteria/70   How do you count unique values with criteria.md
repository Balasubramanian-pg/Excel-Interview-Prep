...
- [36   How do you count unique values.md](..\Counting and Summing Functions\36   How do you count unique values.md) <!-- score: 4.333 | shared: alternative, apple, approach, array, arrays -->
- [35   How do you sum with multiple OR criteria.md](..\Counting and Summing Functions\35   How do you sum with multiple OR criteria.md) <!-- score: 3.568 | shared: array, arrays, check, condition, conditions -->
- [66   How do you sum top or bottom N values.md](66   How do you sum top or bottom N values.md) <!-- score: 3.525 | shared: alternative, approach, array, arrays, containing -->
- [68   How do you sum with OR conditions.md](68   How do you sum with OR conditions.md) <!-- score: 3.485 | shared: array, both, check, condition, conditions -->
- [67   How do you sum with multiple AND conditions.md](67   How do you sum with multiple AND conditions.md) <!-- score: 3.472 | shared: against, alternative, breakdown, condition, conditions -->
