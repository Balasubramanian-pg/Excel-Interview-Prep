...
- [76   How do you extract numbers from text.md](..\Text Pattern Matching\76   How do you extract numbers from text.md) <!-- score: 2.910 | shared: cell, cells, characters, converts, example -->
- [78   How do you count specific characters in text.md](..\Text Pattern Matching\78   How do you count specific characters in text.md) <!-- score: 2.808 | shared: between, case, characters, comprehensive, contents -->
- [19   How do you extract first last name from full name.md](19   How do you extract first last name from full name.md) <!-- score: 2.607 | shared: between, characters, example, excel, extract -->
- [51   What is OFFSET and when do you use it.md](..\Advanced Formula Techniques\51   What is OFFSET and when do you use it.md) <!-- score: 2.591 | shared: cell, cells, contents, empty, example -->
- [115   How do you split text into columns with formulas.md](..\Advanced Data Manipulation\115   How do you split text into columns with formulas.md) <!-- score: 2.578 | shared: cell, cells, delimiter, example, excel -->
