...
- [50   What is INDIRECT and when do you use it.md](50   What is INDIRECT and when do you use it.md) <!-- score: 4.001 | shared: best, cases, cell, circular, compatibility -->
- [52   How do you create a dynamic named range.md](52   How do you create a dynamic named range.md) <!-- score: 3.520 | shared: adjusts, avoid, cell, cells, circular -->
- [60   What is FORMULATEXT.md](..\Advanced Formula Techniques  Continued\60   What is FORMULATEXT.md) <!-- score: 3.285 | shared: best, cases, cell, cells, compatibility -->
- [54   How do you use array constants.md](54   How do you use array constants.md) <!-- score: 3.064 | shared: avoid, best, cases, cells, column -->
- [53   What is CHOOSE function.md](53   What is CHOOSE function.md) <!-- score: 3.052 | shared: best, cases, compatibility, contents, dynamic -->
