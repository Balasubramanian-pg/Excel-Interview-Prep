...
- [57   How do you rank values   Continued.md](..\Advanced Formula Techniques  Continued\57   How do you rank values   Continued.md) <!-- score: 3.709 | shared: analysis, ascending, assign, assigns, average -->
- [50   What is INDIRECT and when do you use it.md](50   What is INDIRECT and when do you use it.md) <!-- score: 3.094 | shared: available, based, best, cases, compatibility -->
- [51   What is OFFSET and when do you use it.md](51   What is OFFSET and when do you use it.md) <!-- score: 2.956 | shared: analysis, average, best, cases, compatibility -->
- [53   What is CHOOSE function.md](53   What is CHOOSE function.md) <!-- score: 2.942 | shared: available, based, best, cases, compatibility -->
- [54   How do you use array constants.md](54   How do you use array constants.md) <!-- score: 2.897 | shared: available, best, cases, compatibility, contents -->
