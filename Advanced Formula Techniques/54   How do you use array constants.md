...
- [60   What is FORMULATEXT.md](..\Advanced Formula Techniques  Continued\60   What is FORMULATEXT.md) <!-- score: 3.233 | shared: available, best, cases, cells, compatibility -->
- [50   What is INDIRECT and when do you use it.md](50   What is INDIRECT and when do you use it.md) <!-- score: 3.147 | shared: available, best, cases, compatibility, contents -->
- [51   What is OFFSET and when do you use it.md](51   What is OFFSET and when do you use it.md) <!-- score: 3.123 | shared: avoid, best, cases, cells, column -->
- [55   What is TRANSPOSE function.md](55   What is TRANSPOSE function.md) <!-- score: 2.945 | shared: array, arrays, best, cases, cells -->
- [53   What is CHOOSE function.md](53   What is CHOOSE function.md) <!-- score: 2.942 | shared: available, best, calculations, cases, compatibility -->
