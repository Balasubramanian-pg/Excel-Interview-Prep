...
- [51   What is OFFSET and when do you use it.md](51   What is OFFSET and when do you use it.md) <!-- score: 4.031 | shared: best, cases, cell, circular, compatibility -->
- [60   What is FORMULATEXT.md](..\Advanced Formula Techniques  Continued\60   What is FORMULATEXT.md) <!-- score: 3.718 | shared: available, behavior, best, cases, cell -->
- [53   What is CHOOSE function.md](53   What is CHOOSE function.md) <!-- score: 3.557 | shared: available, based, behavior, best, cases -->
- [52   How do you create a dynamic named range.md](52   How do you create a dynamic named range.md) <!-- score: 3.222 | shared: based, cell, circular, compatibility, contains -->
- [58   What is GETPIVOTDATA.md](..\Advanced Formula Techniques  Continued\58   What is GETPIVOTDATA.md) <!-- score: 3.142 | shared: available, based, best, cell, compatibility -->
