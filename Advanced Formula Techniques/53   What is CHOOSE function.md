...
- [50   What is INDIRECT and when do you use it.md](50   What is INDIRECT and when do you use it.md) <!-- score: 3.598 | shared: available, based, behavior, best, cases -->
- [60   What is FORMULATEXT.md](..\Advanced Formula Techniques  Continued\60   What is FORMULATEXT.md) <!-- score: 3.285 | shared: available, behavior, best, cases, compatibility -->
- [51   What is OFFSET and when do you use it.md](51   What is OFFSET and when do you use it.md) <!-- score: 3.123 | shared: best, cases, compatibility, contents, dynamic -->
- [56   How do you remove duplicates with formulas.md](56   How do you remove duplicates with formulas.md) <!-- score: 2.990 | shared: behavior, compatibility, contents, does, dynamic -->
- [54   How do you use array constants.md](54   How do you use array constants.md) <!-- score: 2.953 | shared: available, best, calculations, cases, compatibility -->
