...
- [56   How do you remove duplicates with formulas.md](56   How do you remove duplicates with formulas.md) <!-- score: 3.412 | shared: analysis, apple, array, automatically, banana -->
- [62   How do you find the nth occurrence of a value.md](..\Advanced Formula Techniques  Continued\62   How do you find the nth occurrence of a value.md) <!-- score: 3.341 | shared: adjacent, apple, array, arrays, banana -->
- [52   How do you create a dynamic named range.md](52   How do you create a dynamic named range.md) <!-- score: 3.062 | shared: apple, automatically, banana, cells, column -->
- [60   What is FORMULATEXT.md](..\Advanced Formula Techniques  Continued\60   What is FORMULATEXT.md) <!-- score: 3.019 | shared: behavior, best, cases, cells, compatibility -->
- [51   What is OFFSET and when do you use it.md](51   What is OFFSET and when do you use it.md) <!-- score: 3.013 | shared: analysis, best, cases, cells, column -->
