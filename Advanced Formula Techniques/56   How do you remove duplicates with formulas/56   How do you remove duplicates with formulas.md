...
- [55   What is TRANSPOSE function.md](55   What is TRANSPOSE function.md) <!-- score: 3.367 | shared: analysis, apple, array, automatically, banana -->
- [62   How do you find the nth occurrence of a value.md](..\Advanced Formula Techniques  Continued\62   How do you find the nth occurrence of a value.md) <!-- score: 3.291 | shared: apple, array, banana, column, contains -->
- [61   How do you find the last value in a column.md](..\Advanced Formula Techniques  Continued\61   How do you find the last value in a column.md) <!-- score: 3.240 | shared: apple, array, banana, column, compatibility -->
- [59   How do you create running totals.md](..\Advanced Formula Techniques  Continued\59   How do you create running totals.md) <!-- score: 3.183 | shared: analysis, array, changes, column, contains -->
- [60   What is FORMULATEXT.md](..\Advanced Formula Techniques  Continued\60   What is FORMULATEXT.md) <!-- score: 3.128 | shared: behavior, check, compatibility, contains, contents -->
