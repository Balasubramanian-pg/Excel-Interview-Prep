...
- [73   How do you create a searchable dropdown.md](73   How do you create a searchable dropdown.md) <!-- score: 3.086 | shared: cell, containing, create, down, drop -->
- [68   How do you sum with OR conditions.md](..\Conditional Aggregation\68   How do you sum with OR conditions.md) <!-- score: 2.851 | shared: based, check, containing, doesn, enter -->
- [65   How do you sum based on partial text match.md](..\Conditional Aggregation\65   How do you sum based on partial text match.md) <!-- score: 2.811 | shared: based, characters, check, containing, example -->
- [67   How do you sum with multiple AND conditions.md](..\Conditional Aggregation\67   How do you sum with multiple AND conditions.md) <!-- score: 2.778 | shared: based, cell, contain, containing, dynamic -->
- [136   How do you create cross-tabulation  pivot-like  formulas.md](..\Advanced Array Operations\136   How do you create cross-tabulation  pivot-like  formulas.md) <!-- score: 2.686 | shared: category, cell, change, create, down -->
