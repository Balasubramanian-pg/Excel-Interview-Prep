...
- [72   How do you prevent duplicate entries.md](72   How do you prevent duplicate entries.md) <!-- score: 3.359 | shared: advanced, alert, allow, allowed, apply -->
- [25   How do you calculate working days.md](..\Date and Time Functions\25   How do you calculate working days.md) <!-- score: 3.100 | shared: basic, business, custom, date, dates -->
- [26   How do you add working days to a date.md](..\Date and Time Functions\26   How do you add working days to a date.md) <!-- score: 2.878 | shared: business, custom, date, dates, day -->
- [23   How do you calculate age from birthdate.md](..\Date and Time Functions\23   How do you calculate age from birthdate.md) <!-- score: 2.722 | shared: alternative, cell, current, date, dates -->
- [73   How do you create a searchable dropdown.md](73   How do you create a searchable dropdown.md) <!-- score: 2.688 | shared: advanced, alternative, basic, behavior, cell -->
