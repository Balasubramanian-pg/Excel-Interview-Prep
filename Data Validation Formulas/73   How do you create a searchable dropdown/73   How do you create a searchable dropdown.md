...
- [71   How do you create dependent drop-downs.md](71   How do you create dependent drop-downs.md) <!-- score: 3.057 | shared: cell, containing, create, down, drop -->
- [70   How do you count unique values with criteria.md](..\Conditional Aggregation\70   How do you count unique values with criteria.md) <!-- score: 2.823 | shared: alternative, apple, arrays, both, containing -->
- [76   How do you extract numbers from text.md](..\Text Pattern Matching\76   How do you extract numbers from text.md) <!-- score: 2.733 | shared: cell, error, excel, formula, function -->
- [72   How do you prevent duplicate entries.md](72   How do you prevent duplicate entries.md) <!-- score: 2.714 | shared: advanced, apple, behavior, both, case -->
- [36   How do you count unique values.md](..\Counting and Summing Functions\36   How do you count unique values.md) <!-- score: 2.714 | shared: advanced, alternative, apple, arrays, both -->
