...
- [117   How do you create custom sorting orders.md](117   How do you create custom sorting orders.md) <!-- score: 2.839 | shared: array, ascending, column, contains, finds -->
- [56   How do you remove duplicates with formulas.md](..\Advanced Formula Techniques\56   How do you remove duplicates with formulas.md) <!-- score: 2.632 | shared: array, column, contains, counts, enter -->
- [136   How do you create cross-tabulation  pivot-like  formulas.md](..\Advanced Array Operations\136   How do you create cross-tabulation  pivot-like  formulas.md) <!-- score: 2.559 | shared: array, categories, column, enter, etc -->
- [182   BI  How do you calculate variance analysis.md](..\Advanced Business Intelligence Formulas\182   BI  How do you calculate variance analysis.md) <!-- score: 2.542 | shared: assume, checks, column, contains, creating -->
- [67   How do you sum with multiple AND conditions.md](..\Conditional Aggregation\67   How do you sum with multiple AND conditions.md) <!-- score: 2.530 | shared: conditions, containing, designed, example, first -->
