...
- [136   How do you create cross-tabulation  pivot-like  formulas.md](..\Advanced Array Operations\136   How do you create cross-tabulation  pivot-like  formulas.md) <!-- score: 2.981 | shared: array, cell, changes, classic, columns -->
- [137   How do you create dynamic arrays that resize.md](..\Advanced Array Operations\137   How do you create dynamic arrays that resize.md) <!-- score: 2.901 | shared: array, automatically, cell, cells, changes -->
- [76   How do you extract numbers from text.md](..\Text Pattern Matching\76   How do you extract numbers from text.md) <!-- score: 2.852 | shared: array, cell, cells, complex, example -->
- [139   How do you flatten nested arrays.md](..\Advanced Array Operations\139   How do you flatten nested arrays.md) <!-- score: 2.752 | shared: array, automatically, both, cells, columns -->
- [55   What is TRANSPOSE function.md](..\Advanced Formula Techniques\55   What is TRANSPOSE function.md) <!-- score: 2.712 | shared: adjacent, array, automatically, cells, columns -->
