...
- [124   How do you create dynamic conditional formatting formulas.md](124   How do you create dynamic conditional formatting formulas.md) <!-- score: 2.607 | shared: always, based, check, checks, condition -->
- [121   How do you create complex nested conditions.md](121   How do you create complex nested conditions.md) <!-- score: 2.499 | shared: case, condition, conditions, create, evaluates -->
- [117   How do you create custom sorting orders.md](..\Advanced Data Manipulation\117   How do you create custom sorting orders.md) <!-- score: 2.399 | shared: based, create, finds, first, formula -->
- [67   How do you sum with multiple AND conditions.md](..\Conditional Aggregation\67   How do you sum with multiple AND conditions.md) <!-- score: 2.397 | shared: based, condition, conditions, designed, first -->
- [119   How do you group data into bins buckets.md](..\Advanced Data Manipulation\119   How do you group data into bins buckets.md) <!-- score: 2.366 | shared: checks, conditions, designed, finds, first -->
