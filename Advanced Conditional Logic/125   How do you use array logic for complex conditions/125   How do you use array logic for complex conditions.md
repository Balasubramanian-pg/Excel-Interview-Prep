...
- [35   How do you sum with multiple OR criteria.md](..\Counting and Summing Functions\35   How do you sum with multiple OR criteria.md) <!-- score: 3.111 | shared: addition, any, array, arrays, column -->
- [68   How do you sum with OR conditions.md](..\Conditional Aggregation\68   How do you sum with OR conditions.md) <!-- score: 2.965 | shared: addition, array, column, complex, condition -->
- [116   How do you combine multiple criteria with wildcards.md](..\Advanced Data Manipulation\116   How do you combine multiple criteria with wildcards.md) <!-- score: 2.926 | shared: across, allows, any, array, cell -->
- [33   What s the difference between SUM and SUMIF.md](..\Counting and Summing Functions\33   What s the difference between SUM and SUMIF.md) <!-- score: 2.850 | shared: addition, any, apply, cell, condition -->
- [123   How do you handle multiple conditions with scoring.md](123   How do you handle multiple conditions with scoring.md) <!-- score: 2.847 | shared: allows, condition, conditions, core, criteria -->
