...
- [Complex Functions.md](..\Advanced Level\Complex Functions.md) <!-- score: 3.032 | shared: array, cell, cells, characters, complex -->
- [61   How do you find the last value in a column.md](..\Advanced Formula Techniques  Continued\61   How do you find the last value in a column.md) <!-- score: 2.919 | shared: array, best, cells, error, example -->
- [18   Explain all text manipulation functions.md](..\Text Functions\18   Explain all text manipulation functions.md) <!-- score: 2.861 | shared: cell, cells, characters, converts, example -->
- [115   How do you split text into columns with formulas.md](..\Advanced Data Manipulation\115   How do you split text into columns with formulas.md) <!-- score: 2.821 | shared: array, cell, cells, complex, example -->
- [66   How do you sum top or bottom N values.md](..\Conditional Aggregation\66   How do you sum top or bottom N values.md) <!-- score: 2.771 | shared: always, array, example, excel, formula -->
