...
- [60   What is FORMULATEXT.md](..\Advanced Formula Techniques  Continued\60   What is FORMULATEXT.md) <!-- score: 3.019 | shared: best, cases, comprehensive, contents, detailed -->
- [19   How do you extract first last name from full name.md](..\Text Functions\19   How do you extract first last name from full name.md) <!-- score: 2.845 | shared: between, characters, clean, ensure, errors -->
- [18   Explain all text manipulation functions.md](..\Text Functions\18   Explain all text manipulation functions.md) <!-- score: 2.803 | shared: between, case, characters, comprehensive, contents -->
- [64   How do you count cells with specific text.md](..\Conditional Aggregation\64   How do you count cells with specific text.md) <!-- score: 2.742 | shared: case, character, characters, count, counting -->
- [54   How do you use array constants.md](..\Advanced Formula Techniques\54   How do you use array constants.md) <!-- score: 2.720 | shared: best, cases, commas, comprehensive, contents -->
