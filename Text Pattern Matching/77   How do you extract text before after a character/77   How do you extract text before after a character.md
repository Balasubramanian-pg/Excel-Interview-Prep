...
- [78   How do you count specific characters in text.md](78   How do you count specific characters in text.md) <!-- score: 2.299 | shared: best, cases, character, comprehensive, detailed -->
- [60   What is FORMULATEXT.md](..\Advanced Formula Techniques  Continued\60   What is FORMULATEXT.md) <!-- score: 2.196 | shared: best, cases, comprehensive, detailed, document -->
- [20   How do you extract email domain.md](..\Text Functions\20   How do you extract email domain.md) <!-- score: 2.195 | shared: after, before, cases, character, excel -->
- [54   How do you use array constants.md](..\Advanced Formula Techniques\54   How do you use array constants.md) <!-- score: 2.032 | shared: before, best, cases, comprehensive, examples -->
- [19   How do you extract first last name from full name.md](..\Text Functions\19   How do you extract first last name from full name.md) <!-- score: 1.901 | shared: after, before, excel, extract, extracting -->
