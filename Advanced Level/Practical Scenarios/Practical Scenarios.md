...
- [README.md](..\README.md) <!-- score: 2.781 | shared: analysis, columns, common, complex, create -->
- [76   How do you extract numbers from text.md](..\Text Pattern Matching\76   How do you extract numbers from text.md) <!-- score: 2.672 | shared: always, before, complex, error, example -->
- [51   What is OFFSET and when do you use it.md](..\Advanced Formula Techniques\51   What is OFFSET and when do you use it.md) <!-- score: 2.655 | shared: analysis, columns, create, error, example -->
- [Advanced Features.md](Advanced Features.md) <!-- score: 2.613 | shared: add, analysis, clean, click, complex -->
- [114   How do you unpivot data  columns to rows.md](..\Advanced Data Manipulation\114   How do you unpivot data  columns to rows.md) <!-- score: 2.612 | shared: add, analysis, click, columns, excel -->
