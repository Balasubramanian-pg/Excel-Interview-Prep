...
- [76   How do you extract numbers from text.md](..\Text Pattern Matching\76   How do you extract numbers from text.md) <!-- score: 3.077 | shared: array, cell, cells, characters, complex -->
- [70   How do you count unique values with criteria.md](..\Conditional Aggregation\70   How do you count unique values with criteria.md) <!-- score: 2.939 | shared: apple, array, arrays, both, cells -->
- [50   What is INDIRECT and when do you use it.md](..\Advanced Formula Techniques\50   What is INDIRECT and when do you use it.md) <!-- score: 2.926 | shared: cell, compatibility, converts, down, dynamic -->
- [51   What is OFFSET and when do you use it.md](..\Advanced Formula Techniques\51   What is OFFSET and when do you use it.md) <!-- score: 2.898 | shared: analysis, cell, cells, column, compatibility -->
- [Advanced Functions.md](..\Intermediate Level\Advanced Functions.md) <!-- score: 2.852 | shared: array, both, cells, column, complex -->
