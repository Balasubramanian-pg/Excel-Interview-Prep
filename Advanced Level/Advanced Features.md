...
- [52   How do you create a dynamic named range.md](..\Advanced Formula Techniques\52   How do you create a dynamic named range.md) <!-- score: 2.952 | shared: automatically, cells, charts, click, create -->
- [Practical Scenarios.md](Practical Scenarios.md) <!-- score: 2.659 | shared: add, analysis, clean, click, complex -->
- [54   How do you use array constants.md](..\Advanced Formula Techniques\54   How do you use array constants.md) <!-- score: 2.659 | shared: calculations, cases, cells, changes, create -->
- [51   What is OFFSET and when do you use it.md](..\Advanced Formula Techniques\51   What is OFFSET and when do you use it.md) <!-- score: 2.591 | shared: analysis, cases, cells, create, dynamic -->
- [50   What is INDIRECT and when do you use it.md](..\Advanced Formula Techniques\50   What is INDIRECT and when do you use it.md) <!-- score: 2.561 | shared: cases, create, dynamic, example, excel -->
