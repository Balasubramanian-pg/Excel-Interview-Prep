...
- [Complex Functions.md](..\Advanced Level\Complex Functions.md) <!-- score: 2.865 | shared: array, both, cells, column, complex -->
- [10   Explain VLOOKUP in detail.md](..\Lookup Functions\10   Explain VLOOKUP in detail.md) <!-- score: 2.569 | shared: array, col, column, columns, datasets -->
- [76   How do you extract numbers from text.md](..\Text Pattern Matching\76   How do you extract numbers from text.md) <!-- score: 2.545 | shared: array, cells, complex, datasets, example -->
- [68   How do you sum with OR conditions.md](..\Conditional Aggregation\68   How do you sum with OR conditions.md) <!-- score: 2.544 | shared: array, both, column, complex, criteria -->
- [35   How do you sum with multiple OR criteria.md](..\Counting and Summing Functions\35   How do you sum with multiple OR criteria.md) <!-- score: 2.513 | shared: array, column, complex, criteria, different -->
