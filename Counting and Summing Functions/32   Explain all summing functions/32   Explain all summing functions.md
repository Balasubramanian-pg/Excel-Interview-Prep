...
- [31   Explain all counting functions.md](31   Explain all counting functions.md) <!-- score: 3.784 | shared: against, arguments, basic, cell, cells -->
- [33   What s the difference between SUM and SUMIF.md](33   What s the difference between SUM and SUMIF.md) <!-- score: 3.474 | shared: addition, adds, against, argument, arguments -->
- [35   How do you sum with multiple OR criteria.md](35   How do you sum with multiple OR criteria.md) <!-- score: 3.165 | shared: addition, arrays, condition, conditions, criteria -->
- [67   How do you sum with multiple AND conditions.md](..\Conditional Aggregation\67   How do you sum with multiple AND conditions.md) <!-- score: 3.062 | shared: against, arguments, cell, condition, conditions -->
- [34   What is AGGREGATE function.md](34   What is AGGREGATE function.md) <!-- score: 3.023 | shared: aggregation, arrays, basic, cells, conditional -->
