...
- [68   How do you sum with OR conditions.md](..\Conditional Aggregation\68   How do you sum with OR conditions.md) <!-- score: 4.543 | shared: above, addition, array, based, boolean -->
- [67   How do you sum with multiple AND conditions.md](..\Conditional Aggregation\67   How do you sum with multiple AND conditions.md) <!-- score: 3.614 | shared: based, condition, conditions, containing, criteria -->
- [70   How do you count unique values with criteria.md](..\Conditional Aggregation\70   How do you count unique values with criteria.md) <!-- score: 3.564 | shared: array, arrays, check, condition, conditions -->
- [65   How do you sum based on partial text match.md](..\Conditional Aggregation\65   How do you sum based on partial text match.md) <!-- score: 3.541 | shared: added, any, based, check, column -->
- [66   How do you sum top or bottom N values.md](..\Conditional Aggregation\66   How do you sum top or bottom N values.md) <!-- score: 3.476 | shared: above, array, arrays, containing, ctrl -->
