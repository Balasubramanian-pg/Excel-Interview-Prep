...
- [32   Explain all summing functions.md](32   Explain all summing functions.md) <!-- score: 2.961 | shared: aggregation, arrays, basic, cells, conditional -->
- [66   How do you sum top or bottom N values.md](..\Conditional Aggregation\66   How do you sum top or bottom N values.md) <!-- score: 2.890 | shared: array, arrays, errors, excel, explains -->
- [31   Explain all counting functions.md](31   Explain all counting functions.md) <!-- score: 2.781 | shared: advanced, basic, cells, conditional, empty -->
- [64   How do you count cells with specific text.md](..\Conditional Aggregation\64   How do you count cells with specific text.md) <!-- score: 2.742 | shared: array, cells, errors, excel, explains -->
- [36   How do you count unique values.md](36   How do you count unique values.md) <!-- score: 2.714 | shared: advanced, array, arrays, calculation, cells -->
