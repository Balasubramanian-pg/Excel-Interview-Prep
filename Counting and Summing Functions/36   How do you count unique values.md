...
- [70   How do you count unique values with criteria.md](..\Conditional Aggregation\70   How do you count unique values with criteria.md) <!-- score: 4.382 | shared: alternative, apple, approach, array, arrays -->
- [66   How do you sum top or bottom N values.md](..\Conditional Aggregation\66   How do you sum top or bottom N values.md) <!-- score: 3.525 | shared: alternative, approach, array, arrays, containing -->
- [35   How do you sum with multiple OR criteria.md](35   How do you sum with multiple OR criteria.md) <!-- score: 3.471 | shared: array, arrays, containing, ctrl, dynamic -->
- [68   How do you sum with OR conditions.md](..\Conditional Aggregation\68   How do you sum with OR conditions.md) <!-- score: 3.437 | shared: array, both, containing, count, ctrl -->
- [64   How do you count cells with specific text.md](..\Conditional Aggregation\64   How do you count cells with specific text.md) <!-- score: 3.139 | shared: alternative, apple, array, cells, containing -->
